...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    "--diagonal":
      "repeating-linear-gradient( 128deg,#000 0%,hsl(180,10%,60%) 3.8%,hsl(180,10%,60%) 4.5%,hsl(180,10%,60%) 5.2%,#000 10%,#000 12% ) var(--bg-x) var(--bg-y)/300% no-repeat",
    "--shade":
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[260px] aspect-square"
      ref={refElement}
      onPointerMove={(event) => {
